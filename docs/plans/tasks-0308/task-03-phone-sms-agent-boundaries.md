# 任务 03：撰写《给 OpenClaw 一个电话号码》

## 执行状态

- 状态：已完成
- 完成日期：2026-03-08
- 输出位置：`src/content/blog/openclaw-phone-and-sms-boundaries.mdx`
- 输出集合：`blog`

## 任务使命

围绕 Twilio、SMS、语音来电和“让 OpenClaw 替你联系别人”的讨论，写一篇聚焦联系人级代理边界的文章。

## 目标读者

想把 OpenClaw 接入电话 / SMS / 对外沟通渠道的进阶用户。
...
- `src/content/guides/whatsapp-setup.mdx`
- `src/content/guides/telegram-setup.mdx`
- `src/content/guides/openclaw-account-ban-and-tos-risk.mdx`

## 必须核对的外部讨论与信号

- https://www.reddit.com/r/openclaw/comments/1rd1zco/i_built_clawphone_give_your_openclaw_agent_a_real/
- https://www.reddit.com/r/openclaw/comments/1re3eg1/is_it_a_way_to_let_openclaw_talk_to_your_contacts/

## 必须回答的问题

- 区分“给 agent 一个号码”与“让 agent 代表我和联系人交流”的差别。
- 讨论 SMS / 语音通话 / WhatsApp / Telegram 作为对外入口时的不同风险。
- 说明身份声明、误触发、自动回复、审计记录、联系人白名单的重要性。
- 回答“哪些场景可做，哪些场景不要做”。
- 不要写成单纯 Twilio 教程，要把重点放在边界治理。
...
一篇 2200-3200 字的 guide / blog 混合型稿件。
