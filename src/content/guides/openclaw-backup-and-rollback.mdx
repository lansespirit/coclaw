...
seoTitle: "OpenClaw Backup and Rollback with Safe CLI Commands"
seoDescription: "Choose the right backup scope, verify archives, and rehearse rollbacks before upgrades, migrations, or config edits with `openclaw backup create` and `verify`."
reviewedBy:
...
sources:
  - label: 'OpenClaw docs — Gateway runbooks'
