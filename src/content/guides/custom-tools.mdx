...
seoTitle: "Enable Optional Tools and Plugins in OpenClaw"
seoDescription: "Allow optional plugins and tool allowlists, restart the gateway, and verify tool cards so OpenClaw agents can call advanced functions safely."
reviewedBy:
