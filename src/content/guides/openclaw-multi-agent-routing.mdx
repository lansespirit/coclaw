...
seoTitle: "OpenClaw Multi-Agent Routing and Bindings Guide"
seoDescription: "A practical guide to running multiple OpenClaw agents behind one gateway without turning your setup into guesswork."
reviewedBy:
...
sources:
  - label: 'OpenClaw docs — Architecture'
    ...
    type: official-doc
  - label: 'OpenClaw docs — Telegram channel'
