...
seoTitle: "OpenClaw Configuration Guide: openclaw.json, Models & Gateway"
seoDescription: "Configure openclaw.json, model providers, gateway auth, channels, and plugins with safer defaults, clearer mental models, and common fix paths."
reviewedBy:
...
sources:
  - label: 'OpenClaw docs — Gateway configuration reference'
    ...
    type: official-doc
  - label: 'OpenClaw docs — CLI configuration'
