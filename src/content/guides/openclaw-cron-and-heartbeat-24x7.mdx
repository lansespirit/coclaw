...
steps:
  ...
  - title: "Fix the three common cron failure modes"
    content: "Jobs never fire (scheduler regression/timezone), announce delivery fails, or announce delivers only a summary."
...
## 2) The 3 most common cron failure modes (and what to do)
