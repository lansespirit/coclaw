...
seoTitle: "OpenClaw Cron and Heartbeat Reliability Guide"
seoDescription: "Keep the gateway running, prove cron jobs fire, fix scheduler/storage issues, and design evidence-leaving runs before claiming 24/7 automation."
reviewedBy:
...
sources:
  - label: 'OpenClaw docs — Automation cron jobs'
    ...
    type: official-doc
  - label: 'OpenClaw docs — Gateway heartbeat'
