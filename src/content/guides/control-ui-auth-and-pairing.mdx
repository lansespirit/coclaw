...
seoTitle: "Fix Control UI Auth, Pairing, and Remote Dashboard Errors"
seoDescription: "Step-by-step fix for unauthorized and 1008 pairing errors in OpenClaw Control UI, covering tokenized links, device approvals, and safe remote dashboard access."
reviewedBy:
...
sources:
  - label: 'OpenClaw docs — Control UI'
...
2. Verify you can list devices from the same gateway you think you’re hitting:

```bash
openclaw devices list
```

3. Approve the pending request and reload the same tokenized origin:
