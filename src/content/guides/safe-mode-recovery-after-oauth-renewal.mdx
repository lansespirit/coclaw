...
seoTitle: "OpenClaw Safe Mode Recovery After OAuth Renewal"
seoDescription: "Understand why OpenClaw recovery can keep looping after a successful OAuth renewal, and how to resync the live auth file, the provisioned copy, and."
reviewedBy:
...
1. Stop the gateway (so nothing writes while you repair):
...
- Keep the state directory off cloud-sync folders (see: [/troubleshooting/solutions/state-dir-cloud-sync-ebusy-crash](/troubleshooting/solutions/state-dir-cloud-sync-ebusy-crash)).
