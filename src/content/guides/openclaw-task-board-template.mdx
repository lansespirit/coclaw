...
seoTitle: "OpenClaw TASKS.md Template for Visible Agent Work"
seoDescription: "Download a ready-made TASKS.md file for your OpenClaw workspace to track multi-step work, make cron runs leave evidence, and reduce 'it promised but I can't."
reviewedBy:
