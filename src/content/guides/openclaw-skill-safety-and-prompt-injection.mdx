...
seoTitle: "OpenClaw Skill Safety and Prompt Injection Defense"
seoDescription: "A practical hardening guide for OpenClaw operators: reduce skill malware risk, defend against prompt injection from emails/web pages, and design."
reviewedBy:
...
sources:
  - label: 'OpenClaw docs — Control UI auth and pairing'
    ...
    type: official-doc
  - label: 'OpenClaw docs — Cron and heartbeat reliability'
    url: https://docs.openclaw.ai/guides/openclaw-cron-and-heartbeat-24x7
    type: official-doc
