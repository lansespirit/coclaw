...
seoTitle: "OpenClaw Telegram Setup: Bot, Groups & Safe Defaults"
seoDescription: "Connect OpenClaw to Telegram with safer bot setup, group controls, and the common pitfalls that break first-time installs."
reviewedBy:
...
It usually means OpenClaw **saw your Telegram config**, but the channel is not actually enabled/loaded in the running
gateway process.
...
- [/troubleshooting/solutions/telegram-tts-audio-file-instead-of-voice-bubble](/troubleshooting/solutions/telegram-tts-audio-file-instead-of-voice-bubble)
...
- WhatsApp setup: [/guides/whatsapp-setup](/guides/whatsapp-setup)
- Docker gateway setup: [/guides/docker-deployment](/guides/docker-deployment)
- Control UI auth/pairing: [/guides/control-ui-auth-and-pairing](/guides/control-ui-auth-and-pairing)
- Tool allowlists and sandbox policy: [/guides/custom-tools](/guides/custom-tools)
