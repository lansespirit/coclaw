...
seoTitle: "Fix Gateway: service says running but the CLI/UI can't conne"
seoDescription: "Fix 'running but unreachable' gateway states by checking you're probing the right URL, confirming the port is listening, and aligning auth/bind settings."
reviewedBy:
