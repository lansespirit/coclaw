...
seoTitle: "OpenClaw config becomes invalid after you remove a provider"
seoDescription: "Fix config validation failures caused by orphaned `auth.profiles` entries that still reference a provider removed from `models.providers`."
reviewedBy:
