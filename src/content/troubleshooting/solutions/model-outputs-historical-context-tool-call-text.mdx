...
seoTitle: "Fix Model outputs '[Historical context]' / tool-call JSON in"
seoDescription: "Fix chat replies that leak internal tool metadata (e.g. '[Historical context: ... Do not mimic ...]') by switching to a tool-capable model/provider and ensur..."
reviewedBy:
