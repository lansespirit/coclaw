...
seoTitle: "Fix Control UI error: missing scope: operator.read (LAN/IP a"
seoDescription: "Work around a regression where the Control UI works on localhost but fails via LAN/IP with 'missing scope: operator.read'."
reviewedBy:
