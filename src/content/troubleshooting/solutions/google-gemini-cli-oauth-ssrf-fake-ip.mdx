...
seoTitle: "Fix Google Gemini CLI OAuth: SSRF blocked because Google res"
seoDescription: "Fix `google-gemini-cli` login failures where OAuth domains resolve to special-use addresses by verifying DNS on the gateway host and disabling fake-ip/proxy..."
reviewedBy:
