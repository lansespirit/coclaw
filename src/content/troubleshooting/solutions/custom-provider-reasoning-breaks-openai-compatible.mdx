...
seoTitle: "Fix Custom provider fails only when reasoning is enabled"
seoDescription: "Fix custom OpenAI-compatible providers that work in basic chat mode but fail once reasoning or thinking controls are enabled."
reviewedBy:
