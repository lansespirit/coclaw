...
seoTitle: "Fix Docker: 'This version of Antigravity is no longer suppor"
seoDescription: "When Antigravity rejects requests with an update-required message, upgrade OpenClaw (or rebuild your Docker image) and re-authenticate."
reviewedBy:
