...
seoTitle: "Fix Telegram: voice/audio-only messages don't trigger a resp"
seoDescription: "Fix Telegram voice notes that are ignored by enabling inbound audio transcription (tools.media.audio) and ensuring media limits allow downloading/transcribing."
reviewedBy:
