...
seoTitle: "Fix Signal: group sends fail ('Group not found') due to case"
seoDescription: "Fix Signal group targeting failures by preserving the exact group ID casing and upgrading if your version lowercases base64 IDs."
reviewedBy:
