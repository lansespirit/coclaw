...
seoTitle: "Fix Install/Update fails building @discordjs/opus (Raspberry"
seoDescription: "If `openclaw update` or `npm i -g openclaw@...` fails while building `@discordjs/opus`, install build tools and retry with the ARM64 CFLAGS workaround (or pi..."
reviewedBy:
