...
seoTitle: "OpenClaw Tools Fail on Custom OpenAI-Compatible APIs"
seoDescription: "Fix custom AI endpoints that work for plain chat but fail when OpenClaw sends tools, tool_choice, parallel_tool_calls, or later tool-result turns."
reviewedBy:
