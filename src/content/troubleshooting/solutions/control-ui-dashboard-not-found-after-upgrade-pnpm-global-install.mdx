...
seoTitle: "Fix Control UI: dashboard root returns plain-text 'Not Found"
seoDescription: "Fix cases where the gateway starts normally after an upgrade, but `/` returns plain-text `Not Found` until Control UI assets are copied out of the pnpm globa..."
reviewedBy:
