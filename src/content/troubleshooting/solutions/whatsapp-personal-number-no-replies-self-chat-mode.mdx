...
seoTitle: "Fix WhatsApp: using your personal number and the bot won't r"
seoDescription: "If you're running OpenClaw on your personal WhatsApp number, enable self-chat mode and test using 'Message yourself' to avoid loop protection and policy blocks."
reviewedBy:
