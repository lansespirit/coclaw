...
seoTitle: "Fix Gateway: CLI/UI is probing the wrong machine (local vs r"
seoDescription: "Fix confusing 'gateway unreachable' states by aligning gateway.mode, gateway.remote.url, profiles/state dirs, and the URL you probe."
reviewedBy:
