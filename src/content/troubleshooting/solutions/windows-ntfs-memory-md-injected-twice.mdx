...
seoTitle: "Fix Windows (NTFS/WSL2): MEMORY.md is injected twice (case-i"
seoDescription: "Fix doubled bootstrap token cost when `MEMORY.md` and `memory.md` resolve to the same file on a case-insensitive NTFS workspace mount."
reviewedBy:
