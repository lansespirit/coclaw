...
seoTitle: "Fix Discord: 'Failed to resolve Discord application id'"
seoDescription: "Fix Discord startup failures by verifying the bot token and ensuring the gateway host can reach discord.com API endpoints (common in restricted networks)."
reviewedBy:
