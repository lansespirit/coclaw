...
seoTitle: "Fix Web chat: dragging an image opens it in a new tab (no up"
seoDescription: "Work around OpenClaw web chat drag-and-drop image uploads opening in a new tab by using paste/file picker and keeping images small until the UI fix lands."
reviewedBy:
