...
seoTitle: "Fix Telegram CLI: LocalMediaAccessError for --media paths ou"
seoDescription: "Fix `openclaw message send --channel telegram --media <path>` failures by staging the file under OpenClaw's allowed media roots (such as ~/.openclaw/media) b..."
reviewedBy:
