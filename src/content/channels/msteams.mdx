...
seoTitle: 'Microsoft Teams OpenClaw app manifest and permissions'
seoDescription: 'Outline Microsoft Teams OpenClaw setup, covering Azure Bot/webhook reachability, manifest accuracy, RSC vs Graph choices, and conservative DM/group posture.'
reviewedBy:
...
If those pieces feel scattered, keep [/guides/control-ui-auth-and-pairing](/guides/control-ui-auth-and-pairing) and [/guides/openclaw-deployment-troubleshooting](/guides/openclaw-deployment-troubleshooting) close at hand so token, manifest, and pairing conversations stay aligned.
...
When you hit one of those scenarios, revisit [/guides/openclaw-configuration](/guides/openclaw-configuration) for precedence guidance and [/blog/openclaw-model-routing-and-cost-strategy](/blog/openclaw-model-routing-and-cost-strategy) for how routing, policy, and provider choices interact.
...
Frame that permission and consent discussion with [/guides/openclaw-cost-and-guardrails-checklist](/guides/openclaw-cost-and-guardrails-checklist) so finance and security stakeholders see the cost/performance trade-offs while the tenant admins review Graph grants.
...
Continue the Teams path by looping in [/guides/openclaw-operability-and-observability](/guides/openclaw-operability-and-observability) for visibility requirements and [/blog/openclaw-deployment-form-factors-comparison](/blog/openclaw-deployment-form-factors-comparison) when you need to explain how this lane fits the broader self-hosted enterprise story.
